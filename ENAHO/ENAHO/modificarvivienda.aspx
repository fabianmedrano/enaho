<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarvivienda.aspx.cs" Inherits="ENAHO.modificarvi" MaintainScrollPositionOnPostback="true" %>
            ...
            <nav id="spy">
                <ul class="sidebar-nav nav">
                    <li class="sidebar-brand">
                        <a href="#home"><span class="fa fa-home solo">Inicio</span></a>
                    </li>
       
                    <li class="active">
                            <a href="listhogares.aspx">Hogares</a>
                    </li>

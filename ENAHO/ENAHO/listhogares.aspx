<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listhogares.aspx.cs" Inherits="ENAHO.listhogares" %>
        ...
        <div class="col-md-10 center-block ">
            <div class="panel panel-default  ">
                ...
                <div class="panel-body contenido">
                    ...
                    <asp:GridView ID="gb_list_hogares" CssClass=" " runat="server" OnSelectedIndexChanged="gb_list_viviendas_SelectedIndexChanged" OnRowDeleting="gb_list_viviendas_RowDeleting">
                        <Columns>

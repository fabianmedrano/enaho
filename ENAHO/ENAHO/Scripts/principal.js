...
/*
    ...
    */
    ...
    if ($("#rb_mismo_prespuesto input:checked").val() == "false") {
    ...
    if (
        ...
        ($("#rb_esta_vivienda input:checked").val() == "OTRO")
    ) {
    ...
    if ($("#rb_tiene_banos input:checked").val() == "true") {

        $("#line_uso_bano").show();
        $("#row_tiene_banos").show();

    } else {
        $("#row_tiene_banos").hide();// revisar esto
        $("#line_uso_bano").hide();
    }
    if ($("#rb_tiene_banos input:checked").val() == "false") {
    ...
    if ($("#rb_telefono_celular input:checked").val() == "true") {
    ...
    if ($("#rb_telefono_recidencia input:checked").val() == "true") {
    ...
    if ($("#rb_pc_portatil input:checked").val() == "true") {
    ...
    if ($("#rb_pc_escritorio input:checked").val() == "true") {
    ...
    if ($("#rb_tableta input:checked").val() == "true") {
    ...
    if ($("#rb_fax input:checked").val() == "true") {
    ...
    if ($("#rb_radio input:checked").val() == "true") {
        $("#tb_radio_cantidad").show();
    } else {
        $("#tb_radio_cantidad").hide();
    }

    if ($("#rb_carro input:checked").val() == "true") {
        $("#tb_carro_cantidad").show();
    } else {
        $("#tb_carro_cantidad").hide();
    }

    if ($("#rb_moto input:checked").val() == "true") {
        $("#tb_moto_cantidad").show();
    } else {
        $("#tb_moto_cantidad").hide();
    }

    if ($("#rb_tv input:checked").val() == "true") {
        $("#tb_tv_cantidad").show();
    } else {
        $("#tb_tv_cantidad").hide();
    }
    ...
    if ($("#rb_tv_convencional input:checked").val() == "true") {
        $("#tb_tv_convencional_cantidad").show();
    } else {
        $("#tb_tv_convencional_cantidad").hide();
    }
    // otro tipo de tv paga

    if ($("#rb_internet input:checked").val() == "true") {
    ...
    if ($("#rb_otro_tipo_paga input:checked").val() == "true") {
        $("#row_otro_tv_paga").show();
    } else {
        $("#row_otro_tv_paga").hide();
    }
